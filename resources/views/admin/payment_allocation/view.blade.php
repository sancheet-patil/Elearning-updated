...
@section('admin')
    ...
    <div class="card bg-light mt-3">
        <div class="card-header">
            Allocate Payment Percentage
        </div>
        <div class="card-body">
            <form action="{{ route('admin.payment_allocation.save') }}" method="POST" enctype="multipart/form-data">
                @csrf
            ...
            <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="pay_per" required>
                    </div>
                    <div class="form-group">
                        <label>No.of students Reffered</label>
                        <input type="text" class="form-control" name="stud_reff" required>
                    </div>
                    <div class="form-group">
                        <label>Reffered Percentage</label>
                        <input type="text" class="form-control" name="reff_per" required>
                    </div>
