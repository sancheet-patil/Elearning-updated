...
<body>
    ...
    <header class="header clearfix">
        ...
        <div class="main_logo" id="logo">
            <a href="{{ route('teacher.dashboard') }}"><img
                    src="{{ asset('assets/Ntheme/images/left-imgs/livestudyHub.jpg') }}" alt=""></a>
            ...
            <ul>
                ...
                <li class="ui dropdown">
                    ...
                    <div class="menu dropdown_mn">
                        ...
                        <a class="vbm_btn" href="{{ route('teacher.markAsRead') }}">Mark All as Read <i
                                class='uil uil-arrow-right'></i></a>
    ...
    <nav class="vertical_nav">
        <div class="left_section menu_left" id="js-menu">
                ...
                <ul>
                    ...
                    <li class="menu--item">
                        <a href="{{ route('teacher.dashboard') }}"
                            class="{{ Request::segment(2) === null ? 'menu--link active' : 'menu--link' }}"
                            title="Dashboard">
                    ...
                    <li class="menu--item">
                        <a href="{{ route('teacher.subcourses.view') }}"
                            class="{{ Request::segment(2) === 'Request-subcourses' ? 'menu--link active' : 'menu--link' }}"
                            title="Request SubCourse">
                            <i class='uil uil-book-alt menu--icon'></i>
                            <span class="menu--label">Request SubCourse</span>
                        </a>
                    </li>
                    <li class="menu--item">
                        <a href="{{ route('livestream.schedule') }}"
                            class="{{ Request::segment(2) === 'livestream-schedule' ? 'menu--link active' : 'menu--link' }}"
                    ...
                    <li class="menu--item">
                        <a href="{{ route('teacher.group') }}"
                            class="{{ Request::segment(2) === 'Teacher-groups' ? 'menu--link active' : 'menu--link' }}"
                            title="Groups">
                    ...
                    <li class="menu--item">
                        <a href="{{ route('teacher.free_videos.view') }}"
                            class="{{ Request::segment(2) === 'free_videos' ? 'menu--link active' : 'menu--link' }}"
                            title="Analyics">
                    ...
                    <li class="menu--item">
                        <a href="{{ route('blog.addblog') }}"
                            class="{{ Request::segment(2) === 'addblog' ? 'menu--link active' : 'menu--link' }}"
                            title="Create Course">
                    ...
                    <li class="menu--item">
                        <a href="{{ route('teacher.testSeries') }}"
                            class="{{ Request::segment(2) === 'testSeries' ? 'menu--link active' : 'menu--link' }}"
                            title="Notifications">
                    ...
                    <li class="menu--item">
                        <a href="{{ route('teacher.paper') }}"
                            class="{{ Request::segment(2) === 'paper' ? 'menu--link active' : 'menu--link' }}"
                            title="My Certificates">
                            <i class='uil  uil-files-landscapes-alt menu--icon'></i><span>Previous Papers</span>

                    </li>
                    <li class="menu--item">
                        <a href="{{ route('teacher.TeacherReview') }}"
                            class="{{ Request::segment(2) === 'teacher-review' ? 'menu--link active' : 'menu--link' }}"
                            title="Reviews">
                    ...
                    <li class="menu--item">
                        <a href="{{ route('teacher.TeacherEarning') }}"
                            class="{{ Request::segment(2) === 'teacher-earning' ? 'menu--link active' : 'menu--link' }}"
                            title="Earning">
                    ...
                    <li class="menu--item">
                        <a href="{{ route('teacher.TeacherPayout') }}"
                            class="{{ Request::segment(2) === 'teacher-payout' ? 'menu--link active' : 'menu--link' }}"
                            title="Payout">
                    ...
                    <li class="menu--item">
                        <a href="{{ route('teacher.TeacherStatements') }}"
                            class="{{ Request::segment(2) === 'teacher-Statements' ? 'menu--link active' : 'menu--link' }}"
                            title="Statements">
                    ...
                    <li class="{{ route('teacher.TeacherVerification') }}">
                        <a href="instructor_verification.html"
                            class="{{ Request::segment(2) === 'teacher-Verification' ? 'menu--link active' : 'menu--link' }}"
                            title="Verification">
            ...
            <div class="left_section pt-2">
                <ul>
                    <li class="menu--item">
                        <a href="{{ route('teacher.TeacherSetting') }}"
                            class="{{ Request::segment(2) === 'teacher-Setting' ? 'menu--link active' : 'menu--link' }}"
                            title="Setting">
                    ...
                    <li class="menu--item">
                        <a href="{{ route('teacher.TeacherFeedback') }}"
                            class="{{ Request::segment(2) === 'teacher-Feedback' ? 'menu--link active' : 'menu--link' }}"
                            title="Send Feedback">
